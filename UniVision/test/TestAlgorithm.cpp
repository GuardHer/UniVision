...
int TestAlgorithm(int argc, char** argv) {
    try {
        ...
        engine_path = "D:\\Projects\\UniVision\\bin\\conf\\Algorithm\\yolo11l-seg.engine";
        input_path = "D:\\Projects\\UniVision\\bin\\conf\\Algorithm\\TestImage";
        output_path = "D:\\Projects\\UniVision\\bin\\conf\\Algorithm\\output";
        label_path = "D:\\Projects\\UniVision\\bin\\conf\\Algorithm\\yolo11n-seg.txt";
...
int TestAlgorithm2(int argc, char** argv)
{
    ...
    int32_t count;
    auto* plugin = registry->getPluginCreatorList(&count);
	std::cout << "Plugin count: " << count << std::endl;
