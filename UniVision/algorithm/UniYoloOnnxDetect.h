...
public:
	...
	*/
	bool OnnxDetect(const cv::Mat& srcImg, std::vector<OutputParams>& output, cv::Mat& dstImg);
...
private:
	...
	//ONNXRUNTIME	
	Ort::Env _OrtEnv = Ort::Env(OrtLoggingLevel::ORT_LOGGING_LEVEL_ERROR, "Yolov11");
